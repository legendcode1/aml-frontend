...
const LeftBar = ({ savedItems, toggleState }) => {
  // Ensure that the toggleState function is correctly passed and used
  const handlePlusIconClick = () => {
    console.log('Plus icon clicked'); // Log to verify the click
    toggleState(); // Call the toggle function passed as a prop
  };
  ...
  return (
    <div className="left-bar">
      <div className="logo-container">
        ...
        <img 
          src="https://dashboard.codeparrot.ai/api/assets/Z2nNMY6CYQNjI8Wg" 
          alt="Plus" 
          className="plus-icon" 
          onClick={handlePlusIconClick} // Use a separate function for clarity
        />
      </div>
      <hr />
      ...
      <div className="chat-history">
        <div className="chat-header">
          ...
          <div className="icon-group">
            <img src="https://dashboard.codeparrot.ai/api/assets/Z2m_pY6CYQNjI8Ve" alt="Vector" className="icon" />
